// Sample data from the provided 'food.json' file
const foodData = [
    {
        "id": 1,
        "foodname": "Apple",
...
function listFoodItemsWithCategoryGrains(data) {
    return listFoodItemsByCategory(data, 'Grain');
}
...
console.log(listFoodItemsWithCategoryVegetables(foodData));

// Task 3: List all the food items with category fruit
console.log("\nFood items with category 'fruit':");
console.log(listFoodItemsWithCategoryFruit(foodData));

// Task 4: List all the food items with category protein
console.log("\nFood items with category 'protein':");
console.log(listFoodItemsWithCategoryProtein(foodData));

// Task 5: List all the food items with category nuts
console.log("\nFood items with category 'nuts':");
console.log(listFoodItemsWithCategoryNuts(foodData));

// Task 6: List all the food items with category grains
console.log("\nFood items with category 'grains':");
console.log(listFoodItemsWithCategoryGrains(foodData));

// Task 7: List all the food items with category dairy
console.log("\nFood items with category 'dairy':");
console.log(listFoodItemsWithCategoryDairy(foodData));
...
console.log(listFoodItemsByHighestProtein(foodData));

// Task 11: List all the food items with lowest carb content to highest
console.log("\nFood items with lowest carb content to highest:");
console.log(listFoodItemsByLowestCarb(foodData));
